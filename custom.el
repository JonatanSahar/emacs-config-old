...
(custom-set-faces
 ...
 '(line-number-current-line ((t (:inherit (hl-line default) :foreground "#bbc2cf" :weight normal :height 180 :width normal :foundry "GOOG" :family "RobotoMono"))))
 '(org-default ((t (:inherit variable-pitch :weight Light :height 1.05 :family "NotoSans"))))
